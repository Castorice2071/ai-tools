...
betweenCheckbox = modeChecksGroup.add("checkbox", [95, 20, 170, 35], "间距标注");
...
entiretySizeCheck = modeChecksGroup.add("checkbox", [180, 20, 270, 35], "总距离标注");
...
customScaleLabel = modeChecksGroup.add("statictext", [170, 48, 215, 63], "比例:");
customScaleLabel.enabled = true;
customScaleDropdown = modeChecksGroup.add("dropdownlist", [215, 45, 275, 65]);
...
fontdrpLabel = modeChecksGroup.add("statictext", [10, 78, 55, 93], "字体:");
fontdrplist = modeChecksGroup.add("dropdownlist", [55, 75, 275, 95]);
...
fontSizeLabel = modeChecksGroup.add("statictext", [10, 108, 80, 123], "字号大小:");
fontSizeInput = modeChecksGroup.add("edittext", [80, 105, 130, 125], defaultFontSize);
fontSizeInput.helpTip = "标注字体的大小。\n默认值: " + setFontSize + "pt";
fontSizeInput.characters = 6;
fontSizeInput.onActivate = function() {
    restoreDefaultsButton.enabled = true;
};
decimalPlacesLabel = modeChecksGroup.add("statictext", [155, 108, 225, 123], "小数位数:");
decimalPlacesInput = modeChecksGroup.add("edittext", [225, 105, 275, 125], defaultDecimals);
...
lineWeightLabel = modeChecksGroup.add("statictext", [10, 138, 80, 153], "标线宽度:");
lineWeightInput = modeChecksGroup.add("edittext", [80, 135, 130, 155], defaultLineWeight);
...
lineGapLabel = modeChecksGroup.add("statictext", [155, 138, 225, 153], "标线距离:");
lineGapInput = modeChecksGroup.add("edittext", [225, 135, 275, 155], defaultlineGap);
lineGapInput.helpTip = "标注线与对象边界的距离。\n支持负数值，例：-3。\n默认值: " + setgap + "pt";
lineGapInput.characters = 6;
lineGapInput.onActivate = function() {
    restoreDefaultsButton.enabled = true;
};
doubleLineLabel = modeChecksGroup.add("statictext", [10, 168, 65, 183], "界线长:");
doubleLineInput = modeChecksGroup.add("edittext", [65, 165, 100, 185], defaultDoubleLine);
doubleLineInput.helpTip = "标注线两端的短线段。\n默认值: " + setDoubleLine + "pt";
doubleLineInput.characters = 3;
doubleLineInput.onActivate = function() {
    restoreDefaultsButton.enabled = true;
};
arrowCheckbox = modeChecksGroup.add("checkbox", [115, 168, 175, 183], "箭头:");
arrowCheckbox.helpTip = "显示/隐藏标线两端箭头符号。";
arrowCheckbox.value = 1;
triangleSizeLabel = modeChecksGroup.add("statictext", [175, 165, 210, 185], "");
triangleSizeInput = modeChecksGroup.add("edittext", [175, 165, 210, 185], defaultTriangleSize);
triangleSizeInput.helpTip = "标注线两端的箭头尺寸。\n默认值: " + setAsizeSize + "pt";
triangleSizeInput.characters = 3;
triangleSizeInput.enabled = true;
arrowSealingCheckbox = modeChecksGroup.add("checkbox", [225, 168, 275, 183], "实心");
arrowSealingCheckbox.helpTip = "线与面箭头模式切换。";
arrowSealingCheckbox.value = 1;
...
colorLabel = modeChecksGroup.add("statictext", [10, 198, 80, 213], "标注颜色:");
colorInputCyan = modeChecksGroup.add("edittext", [80, 195, 125, 215], defaultColorCyan);
colorInputCyan.helpTip = "青色值 C（0-100）。\n默认值: " + setCyan;
colorInputCyan.characters = 4;
colorInputMagenta = modeChecksGroup.add("edittext", [130, 195, 175, 215], defaultColorMagenta);
colorInputMagenta.helpTip = "红色值 M（0-100）。\n默认值: " + setMagenta;
colorInputMagenta.characters = 4;
colorInputYellow = modeChecksGroup.add("edittext", [180, 195, 225, 215], defaultColorYellow);
colorInputYellow.helpTip = "黄色值 Y（0-100）。\n默认值: " + setYellow;
colorInputYellow.characters = 4;
colorInputBlack = modeChecksGroup.add("edittext", [230, 195, 275, 215], defaultColorBlack);
...
textUnitsCheck = modeChecksGroup.add("checkbox", [10, 225, 85, 240], "单位后缀");
textUnitsCheck.helpTip = "显示标注值单位。\n示例: 220 mm";
textUnitsCheck.value = 1;
textUnitsCheck.onClick = function() {
    restoreDefaultsButton.enabled = true;
};
lineStrokeCheckbox = modeChecksGroup.add("checkbox", [95, 225, 170, 240], "包含描边");
lineStrokeCheckbox.helpTip = "标注包含对象描边的尺寸。";
lineStrokeCheckbox.value = defaultLineStrokes;
lineStrokeCheckbox.onClick = function() {
    restoreDefaultsButton.enabled = true;
};
lockedLay = modeChecksGroup.add("checkbox", [180, 225, 255, 240], "锁标注层");
