...
function icon_panel() {
  ...
  // 使用File.parent获取上级目录
  var iconF1 = new File(scriptFile.parent.parent + "/icon/size.png");
  var iconF2 = new File(scriptFile.parent.parent + "/icon/icon.png");
  var iconF3 = new File(scriptFile.parent.parent + "/icon/mark.png");
  var iconF4 = new File(scriptFile.parent.parent + "/icon/debug.png");
  var iconF5 = new File(scriptFile.parent.parent + "/icon/replace.png");
  var iconF6 = new File(scriptFile.parent.parent + "/icon/gpucard.png");
  var iconF7 = new File(scriptFile.parent.parent + "/icon/byBounds.png");
  var iconF8 = new File(scriptFile.parent.parent + "/icon/repeat.png");
