var CFG = {
    metalColors: [
        { label: "黑镍凸起", name: "Raised  Black  Nickel  Metal" },
        { label: "黑镍凹下", name: "Recessed  Black  Nickel  Metal" },
        { label: "古金凸起", name: "Raised Antique  Gold Metal" },
        { label: "古金凹下", name: "Recessed  Antique Gold Metal" },
        { label: "镀金凸起", name: "Raised  Gold Metal" },
        { label: "镀金凹下", name: "Recessed  Gold Metal" },
        { label: "古青铜凸起", name: "Raised Antique Brass Metal" },
        { label: "古青铜凹下", name: "Recessed  Antique Brass Metal" },
        { label: "镀镍凸起", name: "Raised silver Metal" },
        { label: "镀镍凹下", name: "Recessed silver Metal" },
        { label: "古银凸起", name: "Raised Antique (silver) Metal" },
        { label: "古银凹下", name: "Recessed Antique (silver) Metal" },
        { label: "古红铜凸起", name: "Raised Antique Copper Metal" },
        { label: "古红铜凹下", name: "Recessed  Antique Copper Metal" },
        { label: "染黑凸起", name: "Raised  Dye Black Metal" },
        { label: "染黑凹下", name: "Recessed  Dye Black Metal" },
        { label: "红铜凸起", name: "Raised Shiny Copper Metal" },
        { label: "红铜凹下", name: "Recessed  Shiny Copper Metal" },
        { label: "玫瑰金凸起", name: "Raised  Rose Gold Metal" },
        { label: "玫瑰金凹下", name: "Recessed  Rose Gold Metal" },
        { label: "青铜凸起", name: "Raised Shiny Brass Metal" },
